...
{
  @Test
  @Seeds (value = { @Seed, @Seed ("deadbeef") })
  @Ignore
  public void testV2AgainstV1 ()
  {
    final LangIdV1 v1 = new LangIdV1 ();
    final LangIdV2 v2 = new LangIdV2 ();
    for (int i = 0; i < 100; i++)
    {
      final String in = randomRealisticUnicodeOfCodepointLengthBetween (1, 300);
      final DetectedLanguage c1 = v1.classify (in);
  ...
  {
    final LangIdV2 v2 = new LangIdV2 ();
    final LangIdV3 v3 = new LangIdV3 ();
    for (int i = 0; i < 100; i++)
    {
      final String in = randomRealisticUnicodeOfCodepointLengthBetween (1, 300);
