...
final class LzmaBase
{
  ...
  public static int stateUpdateChar (final int index)
  {
    if (index < 4)
      return 0;
    if (index < 10)
  ...
  public static int stateUpdateMatch (final int index)
  {
    return (index < 7 ? 7 : 10);
  }

  public static int stateUpdateRep (final int index)
  {
    return (index < 7 ? 8 : 11);
  }

  public static int stateUpdateShortRep (final int index)
  {
    return (index < 7 ? 9 : 11);
  }

  public static boolean stateIsCharState (final int index)
  {
    return index < 7;
  }
  ...
  public static int setLenToPosState (final int nLen)
  {
    final int len = nLen - kMatchMinLen;
